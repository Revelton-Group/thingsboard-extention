...
@Component({
  selector: 'tb-water-leak-sensor',
  templateUrl: './water-leak-sensor.component.html',
  styleUrls: ['./water-leak-sensor.component.scss'],
  standalone: false
})
export class WaterLeakSensorComponent {
  @Input() sensor!: any;
